...
select * from retail_sales rs  where rs.sale_date='2022-11-05';

--2. Write a SQL query to retrieve all transactions where the category is 'Clothing' and the quantity sold is more than 4 in the month of Nov-2022
select * from retail_sales rs where 
...
select category,gender,count(*) as total_trancn 
from retail_sales 
...
select customer_id, sum(total_sale) as highest_total_sale from retail_sales
group by 1 
order by 2 
desc limit 5;
...
select shift,count(*) as total_ordrers from hourly_sale group by shift;
